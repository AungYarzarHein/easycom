...
const IntroCard = () => {
  ...
  return (
    <div className="introContainer">
        ...
        <motion.img src={products[count].images[0]} ref={imgRef} className='introImage' initial={{ scale: .6, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: .5, delay: 1 }} key={`${count}img`} />
